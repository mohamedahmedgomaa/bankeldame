...
<footer id="footer">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <img class="footer-logo" src="{{asset('')}}website/imgs/logo.png">
            ...
            <div class="col-md-4">
                <ul class="footer-list">
                    ...
                    <a href="{{url(route('welcome.articles'))}}">
                        <li> المقالات</li>
                    </a>
            ...
            <div class="col-md-4 change-position">
                ...
                <img class="footer-android" src="{{asset('')}}website/imgs/google1.png">
                <img class="footer-ios" src="{{asset('')}}website/imgs/ios1.png">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="social-media">
                    ...
                    <a href="{{url($settings->instagram)}}" target="_blank">
                        <i class="fab fa-instagram hvr-float"></i>
                    </a>
                    <a href="{{$settings->twitter}}" target="_blank">
                        <i class="fab fa-twitter hvr-float"></i>
                    </a>
                    <a href="{{$settings->you_tube}}" target="_blank">
                        <i class="fab fa-youtube hvr-float"></i>
                    </a>
                </div>
